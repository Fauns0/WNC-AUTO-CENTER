...
function FazerAgendamento({ navigateTo }) {
  const handlePageNavigation = () => {
    navigateTo('agendar-manutencao'); // Altera a página para "agendar-manutencao"
  };
  ...
  return (
    <section className="FazerAgendamento">
      ...
      <button onClick={handlePageNavigation} className="cta-button">
        Agendar manutenção →
      </button>
    </section>
  );
